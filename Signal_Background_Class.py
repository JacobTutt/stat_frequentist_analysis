...
class Signal_Background:
    ...
    def fit_params_x(self, initial_params, samples = None, print_results = False, save_to_class = False):
        ...
        # Collect the X components of the samples
        samples_x = samples[:, 0]

        # Define the density function - required by iminuit Extended Unbinned Likelihood
        def density(samples_in, mu, sigma, beta, m, f, N):
        ...
        # Create the negative log-likelihood function
        neg_log_likelihood = ExtendedUnbinnedNLL(samples_x, density)
